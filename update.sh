...
wget -O ./iplist/all-cn.txt https://ispip.clang.cn/all_cn_cidr.txt
wget -O ./iplist/oversea.txt https://raw.githubusercontent.com/billkit/ip-area-route/master/data/apnic_china_0_v4.txt
